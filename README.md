...
| Instruction-Tuned LLM with mpt-7b-instruct | [link to model](https://huggingface.co/mosaic/mpt-7b-instruct) | [link to script](examples/mpt-7b-instruct(pyfunc).py) |
